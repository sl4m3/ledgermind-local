...
from ledgermind_local.projections import GGUFVectorizer, VectorProjectionStore
from ledgermind_local.projections.vectorizer import Vectorizer
from ledgermind_local.search.fts import SQLiteKnowledgeSearchAdapter
...
class HybridKnowledgeSearchAdapter(KnowledgeSearch):
    ...
    def _build_vector_hits(
        ...
        for knowledge_id, raw_vector in zip(knowledge_ids, raw_vectors):
            ...
            except Exception:  # noqa: BLE001, S112 - skip malformed vector candidate
                continue
