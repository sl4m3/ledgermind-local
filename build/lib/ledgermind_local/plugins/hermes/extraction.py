...
from ledgermind_core.domain import SourceReference
...
def _normalize_message_for_model(message: Mapping[str, Any]) -> dict[str, Any]:
    ...
    for raw_entry in tool_call_items:
...
def _read_extraction_response(payload: Any) -> tuple[dict[str, Any], ExtractionCallMetadata]:
    ...
    normalized: dict[str, Any] = {
        ...
        "artifacts": tuple(raw_artifacts) if isinstance(raw_artifacts, (list, tuple)) else (),
    }
